            ...
            <ul>
                {
                    ...
                    habitsList.map(singleHabit => {
                        return (
                            <div key={singleHabit.id} class="flex flex-col justify-start items-start mt-4 mb-2 border px-3 mx-6 py-4 bg-gray-200 rounded sm:flex sm:flex-row">
                                ...
                                <button onClick={() => onDeleteHabit(singleHabit.id)} class="bg-red-500 font-bold text-white hover:outline-none">Delete</button> 
                            </div>
                        )
                    })
                }
